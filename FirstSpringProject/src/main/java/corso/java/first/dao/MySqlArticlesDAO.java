...
public class MySqlArticlesDAO implements ArticlesDAO {
	private final Logger log = LoggerFactory.getLogger(MySqlArticlesDAO.class);
	...
	public MySqlArticlesDAO() {
		log.info("Sto usando MySQL");
		try {
